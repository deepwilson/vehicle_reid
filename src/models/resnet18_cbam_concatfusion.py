...
class CBAM_ResNet18(nn.Module):
    def __init__(self, loss, num_classes=576, pretrained=True, **kwargs):
        ...
        dropout_p = None
        hidden_dim = 1024
        layers.append(nn.Linear(1024, hidden_dim))
        ...
        self.upsample = nn.Sequential(nn.Conv2d(256, 512, kernel_size=1, stride=2, bias=False),
                                      nn.BatchNorm2d(512))
...
def resnet18_cbam_concatfusion(num_classes, loss={"xent"}, **kwargs):
