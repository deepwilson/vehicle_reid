...
class MobileNetV3(nn.Module):
    def __init__(self,
        ...
        # dropout_p = None
        # hidden_dim = 512
        # layers.append(nn.Linear(lastconv_output_channels, last_channel),)
        # layers.append(nn.Linear(last_channel, hidden_dim))
...
def samobilenet_v3_small(loss = {"xent", "htri"}, pretrained: bool = True, progress: bool = True, **kwargs: Any) -> MobileNetV3:
...
if __name__=="__main__":
    ...
    model = samobilenet_v3_small(pretrained=True, loss = {"xent", "htri"})
